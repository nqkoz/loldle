    ...
    function jeu($nomChampion)
    {
        ...
        if ($idChampion == $_SESSION['idrandom']) {
            ...
            if ($conn->query($sqlTruncate) === TRUE) {  
                ...
                echo '      </div>';
                echo '    </div>';
                echo '    <a href="Accueil.php"><img class = "rejouer" src="./images/rejouer.png"></a>';   
                echo '  </div>';
            }
            }
        $conn->close();
  ...
  <div class="jeu1">
        <form action="" id="Loldle" method="post">
            ...
            <div class="barrerecherche">
                <input type="text" id="rechercheChampion" name="rechercheChampion" placeholder="   Tape le nom d'un champion" class="recherche">
